...
<body
	...
	<div id="subCategoryModel" class="modal fade text-left addmodal" data-keyboard="false"
		...
		<div
			...
			<div class="modal-content">
				<div class="modal-header">
					<label class="modal-title " id="">Add/Edit Sub-Category
						Master</label>
					...
					<div class="card m-b-5">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-xl-12 col-lg-12 col-sm-12 mb-2">
									<label class=" lable-align">Sub-Category Name</label> <input
										id="subCategoryName" type="text"
					...
					<div class="row">
						...
						<div class="col-xl-6 col-lg-6 col-sm-6 text-right colmspadding">
							<a href="javascript:void(0)"
								onClick="InsertAndUpdateSubCategory()"
	...
	<script src="/product_master_js/subCategory_validation.js"></script>
</body>
<!-- END: Body-->
