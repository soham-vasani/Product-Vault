...
<body class="horizontal-layout horizontal-menu  navbar-sticky footer-fixed  " data-open="hover"
                ...
                <form name="loginForm" class="m-t-5 loginforms">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="password" id="password" maxlength="15" class="form-control" placeholder="Enter Password">
                    </div>
                  </div>
                  <a class="btn btn-primary btn-block" onClick="loginUser()" ><i class="fas fa-sign-out-alt m-r-5"></i>Login </a>                
                  <a class="btn btn-success btn-block" href="http://localhost:9090/signup" ><i class="fas fa-user-plus m-r-5"></i>Sign Up </a>                
            </div>
                </form>
  ...
  <script src="/product_master_js/login.js"></script>
</body>
<!-- END: Body-->
